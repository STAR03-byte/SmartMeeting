...
def _simple_traditional_to_simplified(text: str) -> str:
    _CONV = {
        "為": "为", "們": "们", "裡": "里", "說": "说", "時": "时",
        "會": "会", "對": "对", "這": "这", "來": "来", "個": "个",
        "嗎": "吗", "呢": "呢", "吧": "吧", "啊": "啊", "哦": "哦",
...
def normalize_to_simplified_text(text: str) -> str:
    ...
    try:
        ...
        return _simple_traditional_to_simplified(text)
...
class WhisperTranscriber:
    ...
    def _normalize_to_simplified(self, text: str) -> str:
        return normalize_to_simplified_text(text)
                ...
                segments.append(
                    {
                        ...
                        + offset_seconds,
                        "text": normalize_to_simplified_text(text.strip()) if isinstance(text, str) else "",
