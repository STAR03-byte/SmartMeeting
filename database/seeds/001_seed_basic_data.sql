...
INSERT INTO users (
  ...
  (4001, 'alice_admin', 'alice@example.com', '$pbkdf2-sha256$29000$KSUkZEwpJYSQslbK.X8P4Q$2JZcb3CZFNxMEF8PANHoLjyOhIUNWFZH8e02GQJVCP8', 'Alice Chen', 'admin', 1, NOW(), '2026-03-12 09:00:00', '2026-03-12 09:00:00'),
  (4002, 'bob_pm', 'bob@example.com', '$pbkdf2-sha256$29000$KSUkZEwpJYSQslbK.X8P4Q$2JZcb3CZFNxMEF8PANHoLjyOhIUNWFZH8e02GQJVCP8', 'Bob Li', 'member', 1, NOW(), '2026-03-12 09:00:00', '2026-03-12 09:00:00'),
  (4003, 'cindy_dev', 'cindy@example.com', '$pbkdf2-sha256$29000$KSUkZEwpJYSQslbK.X8P4Q$2JZcb3CZFNxMEF8PANHoLjyOhIUNWFZH8e02GQJVCP8', 'Cindy Wang', 'member', 1, NOW(), '2026-03-13 10:00:00', '2026-03-13 10:00:00');
