...
INSERT INTO users (
  ...
  (4001, 'alice_admin', 'alice@example.com', '$pbkdf2-sha256$29000$KSUkZEwpJYSQslbK.X8P4Q$2JZcb3CZFNxMEF8PANHoLjyOhIUNWFZH8e02GQJVCP8', 'Alice Chen', 'admin', TRUE, NOW(), '2026-03-12 09:00:00', '2026-03-12 09:00:00'),
  (4002, 'bob_pm', 'bob@example.com', '$pbkdf2-sha256$29000$KSUkZEwpJYSQslbK.X8P4Q$2JZcb3CZFNxMEF8PANHoLjyOhIUNWFZH8e02GQJVCP8', 'Bob Li', 'member', TRUE, NOW(), '2026-03-12 09:00:00', '2026-03-12 09:00:00'),
  (4003, 'cindy_dev', 'cindy@example.com', '$pbkdf2-sha256$29000$KSUkZEwpJYSQslbK.X8P4Q$2JZcb3CZFNxMEF8PANHoLjyOhIUNWFZH8e02GQJVCP8', 'Cindy Wang', 'member', TRUE, NOW(), '2026-03-13 10:00:00', '2026-03-13 10:00:00');

-- 重置序列值以避免后续 INSERT 冲突
SELECT setval(pg_get_serial_sequence('users', 'id'), 4100);
...
SELECT setval(pg_get_serial_sequence('meetings', 'id'), 3100);
...
SELECT setval(pg_get_serial_sequence('meeting_transcripts', 'id'), 2100);
...
SELECT setval(pg_get_serial_sequence('tasks', 'id'), 1100);
